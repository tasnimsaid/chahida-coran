...
document.getElementById("alif13").innerHTML=Counter31*4;

document.getElementById("laa3").innerHTML=Counter32;
document.getElementById("laa23").innerHTML=Counter32*5;

document.getElementById("haa3").innerHTML=Counter33;
document.getElementById("haa33").innerHTML=Counter33*17;

document.getElementById("mim3").innerHTML=Counter34;
document.getElementById("mim43").innerHTML=Counter34*8;

document.getElementById("dal3").innerHTML=Counter35;
document.getElementById("dal53").innerHTML=Counter35*3;

document.getElementById("haae3").innerHTML=Counter36;
document.getElementById("haae63").innerHTML=Counter36*2;

document.getElementById("raa3").innerHTML=Counter37;
document.getElementById("raa73").innerHTML=Counter37*24;

document.getElementById("baa3").innerHTML=Counter38;
document.getElementById("baa83").innerHTML=Counter38*13;

document.getElementById("ine3").innerHTML=Counter39;
document.getElementById("ine93").innerHTML=Counter39*11;

document.getElementById("yaa3").innerHTML=Counter310;
document.getElementById("yaa103").innerHTML=Counter310*9;

document.getElementById("noon3").innerHTML=Counter311;
document.getElementById("noon113").innerHTML=Counter311*6;

document.getElementById("kaf3").innerHTML=Counter312;
document.getElementById("kaf123").innerHTML=Counter312*10;


document.getElementById("ouaou3").innerHTML=Counter313;
document.getElementById("ouaou133").innerHTML=Counter313*7;
...
document.getElementById("taa153").innerHTML=Counter315*19;

document.getElementById("saad3").innerHTML=Counter316;
document.getElementById("saad163").innerHTML=Counter316*25;

document.getElementById("ttae3").innerHTML=Counter317;
document.getElementById("ttae173").innerHTML=Counter317*15;

document.getElementById("ppaf3").innerHTML=Counter318;
document.getElementById("ppaf183").innerHTML=Counter318*12;


document.getElementById("ddal3").innerHTML=Counter319;
document.getElementById("ddal193").innerHTML=Counter319*21;

document.getElementById("gaa3").innerHTML=Counter320;
document.getElementById("gaa203").innerHTML=Counter320*23;

document.getElementById("daa3").innerHTML=Counter321;
document.getElementById("daa213").innerHTML=Counter321*27;

document.getElementById("faa3").innerHTML=Counter322;
document.getElementById("faa223").innerHTML=Counter322*20;

document.getElementById("zay3").innerHTML=Counter323;
document.getElementById("zay233").innerHTML=Counter323*16;

document.getElementById("kha3").innerHTML=Counter324;
document.getElementById("kha243").innerHTML=Counter324*18;

document.getElementById("chine3").innerHTML=Counter325;
document.getElementById("chine253").innerHTML=Counter325*1;

document.getElementById("ddda3").innerHTML=Counter326;
document.getElementById("ddda263").innerHTML=Counter326*28;

document.getElementById("jim3").innerHTML=Counter327;
document.getElementById("jim273").innerHTML=Counter327*22;

document.getElementById("ttta3").innerHTML=Counter328;
document.getElementById("ttta283").innerHTML=Counter328*26;



document.getElementById("text3").addEventListener("keyup",countWord3);

allsenda =  Counter31*4 + Counter32*5 + Counter33*17 + Counter34*8 + Counter35*3 + Counter36*2 + Counter37*24 + Counter38*13 + Counter39*11 + Counter310*9 + Counter311*6 + Counter312*10 + Counter313*7 + Counter314*14 + Counter315*19 + Counter316*25 + Counter317*15 + Counter318*12 + Counter319*21 + Counter320*23 + Counter321*27 + Counter322*20 + Counter323*16 + Counter324*18 + Counter325*1 + Counter326*28 + Counter327*22 + Counter328*26  ;
document.getElementById("best33").innerHTML= Counter31*4 + Counter32*5 + Counter33*17 + Counter34*8 + Counter35*3 + Counter36*2 + Counter37*24 + Counter38*13 + Counter39*11 + Counter310*9 + Counter311*6 + Counter312*10 + Counter313*7 + Counter314*14 + Counter315*19 + Counter316*25 + Counter317*15 + Counter318*12 + Counter319*21 + Counter320*23 + Counter321*27 + Counter322*20 + Counter323*16 + Counter324*18 + Counter325*1 + Counter326*28 + Counter327*22 + Counter328*26  ;
